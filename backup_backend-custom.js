...
673605530118
        ...
        Tasks: {
            selectors: {
                select2: jQuery(".select2"),//document.getElementsByClassName('classname')
                taskFile: document.getElementById('task_file'),//jQuery("#task_file")
                previewContainer : document.getElementById('file_preview')
            },
            init : function () {
                this.selectors.select2.select2();
                this.selectors.taskFile.onchange = function () {
                    Backend.Tasks.selectors.previewContainer.src = '';
                    if (Backend.FileUpload.allowFile(this.files[0].name.split('.').pop())) {
                        Backend.FileUpload.PreviewImage(this, Backend.Tasks.selectors.previewContainer);
                        Backend.Tasks.selectors.previewContainer.style.maxWidth = '500px';
                        Backend.Tasks.selectors.previewContainer.style.display = 'block';    
                        return true;
                    } else {
        ...
        FileUpload : {
            ...
            PreviewImage: function (inputFile,previewImg) {
            ...
            allowFile : function (fileExtension) {
